...
extern void *mono_aot_module_SmartechXamarin_info;
...
{
	mono_aot_register_module (mono_aot_module_SmartechXamarin_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SmartechXamarin.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
